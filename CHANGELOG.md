...
- Added explicit habit archiving and resurrection behavior.
...
- Added `/stats` for browsing habit statistics, including current streaks, longest streaks, streak history, start dates, archive dates, and note counts.
